...
sources:
  - tier: S
    outlet: WTOC
    title: "Chatham County police arrest man for using AI to scam store"
    url: "https://www.wtoc.com/2026/09/10/chatham-county-police-arrest-man-using-ai-scam-store/"
  ...
  - tier: S
    outlet: WSB-TV
    title: "Man uses AI-created accounts to pose as delivery driver, police say"
    url: "https://www.wsbtv.com/news/georgia/man-uses-ai-created-accounts-pose-delivery-driver-police-say/SWQJL7EA2ZBFZNDYF45YWL53GM/"
    retrieved: 2026-09-19
  - tier: S
    outlet: Hoodline
    title: "Chatham County man used AI-made accounts to fake delivery pickup, police say"
    url: "https://hoodline.com/2026/09/chatham-county-man-used-ai-made-accounts-to-fake-delivery-pickup-police-say/"
    retrieved: 2026-09-19
  - tier: S
    outlet: Informing News
    title: "Man arrested in AI-linked scam involving Walmart"
    url: "https://informingnews.com/chatham-county-man-arrested-in-ai-linked-delivery-scam/"
    retrieved: 2026-09-19
  - tier: P
    outlet: Chatham County Police Department
    title: "Newsroom (no release located for this case)"
    url: "https://police.chathamcountyga.gov/Media/Newsroom"
    retrieved: 2026-09-19
---
...
are not the same assertion, and no source reconciles them.

For a record that turns on what the technology did, the difference matters.
Generating a credential is not the same act as generating a document.

## An unverified federal claim

One outlet reports that WSAV described FBI involvement in the case, while
noting in the same breath that no independent FBI announcement could be
located. This record has not been able to read the WSAV report directly and
has found no federal announcement either.

If a federal agency is involved in a case carrying a $1,300 bond on an
attempted misdemeanour, that is the most significant fact about it and no
outlet has developed it. If the claim is mistaken, it is a propagation error
worth recording. **Unresolved.**

## What the chief actually said

Because headlines about first arrests travel badly, the underlying claim is
worth quoting at its narrowest. Chief Jeff Hadley said this was the first
time artificial intelligence had featured in a criminal investigation within
his department's jurisdiction.

That is a careful and modest statement about one Georgia department's
caseload, and the outlets covering it reported it as such. It is not a claim
about a national first, and this record found no coverage that inflated it
into one. Readers arriving from a headline should hold it at the size the
chief gave it.

The more durable detail from the same interview is that Hadley said his
agency is meeting with national police think tanks to develop tactics for
investigating AI-driven crime. A department that has charged one attempted
misdemeanour is already seeking outside help on method. That gap between the
scale of the case and the scale of the response is the part of this story
